 ...
 * @author Admin
 */
public abstract class Animal { // Clase abstracta, ya que no sabemos que animal es si no nos lo dicen.
    ...
    public abstract void mover(); //Método abstracto porque no sabemos como se mueve un animal aleatorio.
