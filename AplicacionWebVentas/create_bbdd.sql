...
START TRANSACTION;
USE `bd_ventas`;
INSERT INTO `bd_ventas`.`cliente` (`id`, `nombre`, `email`, `edad`, `activo`, `password`) VALUES (DEFAULT, 'Prueba', 'prueba@email.com', 20, 0, '123');
...
START TRANSACTION;
USE `bd_ventas`;
INSERT INTO `bd_ventas`.`producto` (`id`, `nombre`, `cantidad`, `precio`) VALUES (DEFAULT, 'Prueba', 1, 1);
